...
const Setup: NextPage = () => {
  ...
  return (
    <>
      <Head>
        <title>U2U Multisign – Settings – Setup</title>
      </Head>
          ...
          <Grid container spacing={3}>
            <Grid item lg={4} xs={12}>
              <Typography variant="h4" fontWeight={700}>
                ...
                <Tooltip
                  placement="top"
                  title="For security reasons, transactions made with U2U Multisign need to be executed in order. The nonce shows you which transaction will be executed next. You can find the nonce for a transaction in the transaction details."
                >
                  <span>
                    <SvgIcon
                      component={InfoIcon}
